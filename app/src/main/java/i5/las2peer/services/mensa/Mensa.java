  ...
  @SwaggerDefinition(
      info = @Info(title = "360", version = "0.0.0",
          ...
          license = @License(name = "BSD",
              url = "https://github.com/GHProjectsTest/microservice-360/blob/master/LICENSE.txt") ) )
  @Path("/")
  ...
  public Response postDishRating(@PathParam("id") String id, String body) {
   ...
   try { 
    ...
    if(not_found_condition) {
      JSONObject not_foun = new JSONObject();

      

      return Response.status(HttpURLConnection.HTTP_NOT_FOUND).entity(not_foun.toJSONString()).build();
    }
    return null;
  }
